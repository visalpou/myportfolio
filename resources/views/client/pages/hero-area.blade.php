...
@section('main')
    ...
    @include('client.pages.aboutus');	
    @include('client.pages.service');
    @include('client.pages.fun-fact');
    @include('client.pages.call-to-action');
    @include('client.pages.blog-area');
    @include('client.pages.partners');
@endsection